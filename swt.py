...
render_temperature(station_data, selected_station_name, selected_start_date, selected_end_date)
render_precipitation(station_data, selected_station_name, selected_start_date, selected_end_date)
render_snow(station_data, selected_station_name, selected_start_date, selected_end_date)
render_wind(station_data, selected_station_name, selected_start_date, selected_end_date)
render_pressure(station_data, selected_station_name, selected_start_date, selected_end_date)
render_sunshine(station_data, selected_station_name, selected_start_date, selected_end_date)
